...
export const GET_REST_DASHBOARD_PENDING = "GET_REST_DASHBOARD_PENDING";
export const GET_REST_DASHBOARD_SUCCESS = "GET_REST_DASHBOARD_SUCCESS";
export const GET_REST_DASHBOARD_FAILED = "GET_REST_DASHBOARD_FAILED";