...
const graphReducer = (state = graphState, action) => {
    switch(action.type){
        ...
        case actions.GET_GRAPH_DATA_CONFIRMED_SUCCESS: 
            return Object.assign({}, state, {graphDataPending: false, graphData: action.payload});
        case actions.GET_GRAPH_DATA_CONFIRMED_FAILED: 
            return Object.assign({}, state, {graphDataPending: false, graphDataError: action.payload});
